...
public class CardStorageReader {
  ...
  *            exists.
  */
  public CardStorageReader(String cardDataDir,
                           CardStorageReader.ProgressObserver progressObserver,
                           Observer observer) {
    this.progressObserver = progressObserver;
    if (progressObserver == null) {
      this.progressObserver = CardStorageReader.ProgressObserver.emptyObserver;
    }
    ...
    if (!cardsfolder.exists()) {
      throw new RuntimeException(
          "CardReader : constructor error -- " + cardsfolder.getAbsolutePath() +
